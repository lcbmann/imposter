...
const WORD_BANK = {
  Food: [
    ...
    { word: "Spaghetti", hint: "Twisted tomato pasta" },
    { word: "Salad", hint: "Crunchy greens in a bowl" },
    { word: "Donut", hint: "Frosted breakfast ring" },
    { word: "Soup", hint: "Warm bowl with a spoon" },
    { word: "Sandwich", hint: "Stacked between bread" },
    { word: "Fries", hint: "Crispy potato sticks" },
    { word: "Apple", hint: "Keeps the doctor away" },
    { word: "Chocolate", hint: "Sweet cocoa bar" },
    { word: "Cheese", hint: "Goes on crackers" },
    { word: "Burrito", hint: "Wrapped and stuffed tortilla" },
    { word: "Ice Cream", hint: "Cold scoop in a cone" },
    { word: "Steak", hint: "Grilled beef cut" },
    { word: "Noodles", hint: "Long strands in broth" },
  ...
  Animals: [
    ...
    { word: "Owl", hint: "Big eyes, night flyer" },
    { word: "Zebra", hint: "Striped grass grazer" },
    { word: "Otter", hint: "River swimmer with whiskers" },
    { word: "Fox", hint: "Sly red forest hunter" },
    { word: "Cat", hint: "Purrs and naps" },
    { word: "Dog", hint: "Loyal tail wagger" },
    { word: "Rabbit", hint: "Hops with long ears" },
    { word: "Turtle", hint: "Carries a shell" },
    { word: "Bear", hint: "Big, loves honey" },
    { word: "Whale", hint: "Giant ocean singer" },
    { word: "Parrot", hint: "Colorful talking bird" },
    { word: "Horse", hint: "Fast with a mane" },
    { word: "Lion", hint: "Roaring mane king" },
    { word: "Sheep", hint: "Fluffy wool grazer" },
  ],
  Travel: [
    ...
    { word: "Map", hint: "Paper guide with streets" },
    { word: "Train", hint: "Fast on tracks" },
    { word: "Airport", hint: "Where flights take off" },
    { word: "Taxi", hint: "Yellow ride with a meter" },
    { word: "Backpack", hint: "Carries all your gear" },
    { word: "Hotel", hint: "Room with a keycard" },
    { word: "Beach", hint: "Sand, sun, waves" },
    { word: "Cruise", hint: "Vacation on a ship" },
    { word: "Bus", hint: "City ride with seats" },
    { word: "Guidebook", hint: "Pages of tips" },
    { word: "Postcard", hint: "Mailed trip photo" },
    { word: "Ferry", hint: "Boat that carries cars" },
    { word: "Mountain", hint: "Tall hike with views" },
    { word: "Sunscreen", hint: "Lotion for sunny days" },
    { word: "Pillow", hint: "Neck saver on flights" },
  ],
  Sports: [
    ...
    { word: "Baseball", hint: "Bat, bases, and a diamond" },
    { word: "Golf", hint: "Clubs, greens, quiet swings" },
    { word: "Bowling", hint: "Ten pins in a lane" },
    { word: "Cycling", hint: "Two wheels and a helmet" },
    { word: "Running", hint: "Laces tied, hit the track" },
    { word: "Swimming", hint: "Laps in the pool" },
    { word: "Skateboard", hint: "Deck with four wheels" },
    { word: "Yoga", hint: "Stretch and breathe" },
    { word: "Surfing", hint: "Ride the wave" },
    { word: "Table Tennis", hint: "Tiny paddles, fast ball" },
    { word: "Badminton", hint: "Birdie over a net" },
    { word: "Rugby", hint: "Scrum with an oval ball" },
    { word: "Boxing", hint: "Gloves and a bell" },
    { word: "Skiing", hint: "Glide on snow" },
    { word: "Jump Rope", hint: "Spin the rope, light feet" },
  ],
  Movies: [
    ...
    { word: "Villain", hint: "Plots the trouble" },
    { word: "Camera", hint: "Captures every scene" },
    { word: "Script", hint: "Lines on the page" },
    { word: "Ticket Stub", hint: "Proof you bought a seat" },
    { word: "Actor", hint: "Performs the role" },
    { word: "Costume", hint: "Character outfit" },
    { word: "Soundtrack", hint: "Songs of the film" },
    { word: "Clapperboard", hint: "Snap before a take" },
    { word: "Cartoon", hint: "Animated story" },
    { word: "Subtitle", hint: "Words at the bottom" },
    { word: "Snack Bar", hint: "Candy and soda stand" },
    { word: "Premiere", hint: "First public showing" },
    { word: "Poster", hint: "Big ad for the movie" },
    { word: "Plot", hint: "The main story" },
  ],
};
